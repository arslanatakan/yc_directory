...
// Query: *[_type == "playlist" && slug.current == $slug][0]{  _id,  title,  slug,  select[]->{    _id,    title,    slug,    _createdAt,    author->{      _id,      name,      image,      bio,      slug    },    views,    description,    category,    image,    pitch  }}
